...
// derivada de Paul Irish https://gist.github.com/paulirish/1579671 - thanks for your code!
...
// derivada de Dan Pupius www.pupius.net
    ...
    if (this.ishwscroll) {  
      ...
      //derivada de http://stackoverflow.com/questions/11236090/
    ...
    function getZIndex() {
      var dom = self.win;
      if ("zIndex" in dom) return dom.zIndex();  // usando jQuery UI metodo when available
      while (dom.length>0) {        
...
// de MDN https://developer.mozilla.org/en-US/docs/DOM/Mozilla_event_reference/wheel
